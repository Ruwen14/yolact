        ...
        for epoch in range(num_epochs):
            ...
            for datum in data_loader:
                ...
                if args.log and iteration % 20 == 0:
                    ...
                    wandb.log({'BBox Loss Train': log_stuff['loss']['B']}, step=iter_step)
                    wandb.log({'Mask Loss Train': log_stuff['loss']['M']}, step=iter_step)
                    wandb.log({'Class Confidence Loss Train': log_stuff['loss']['C']}, step=iter_step)
                    wandb.log({'Semantic Segmentation Loss Train': log_stuff['loss']['S']}, step=iter_step)
                    wandb.log({'Total Train Loss': log_stuff['loss']['T']}, step=iter_step)
                    wandb.log({'Learning Rate': log_stuff['lr']}, step=iter_step)
                    wandb.log({'Epoch Train': log_stuff['epoch']})
